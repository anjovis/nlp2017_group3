...
def disambiguate_with_wikipedia(disambiguated_word, context, verbose=False):
    ...
    senses = config.wikipedia_senses
    for item in senses:
...
if __name__ == "__main__":
    ...
    for word in test_dict['corpus']['lexelt']:
        ...
        for instance in word['instance']:
            ...
            predicted_sense = disambiguate_with_wikipedia(word_to_be_disambiguated, context, verbose=False)
            ...
            print('correct_sense:', config.wn17_to_wikipedia[correct_sense])
